...
% Needed packages according to operating system
%
%   Arch Linux                  Ubuntu
%   texlive-bin                 texlive-core
%   texlive-core                texlive-fonts-extra
%   texlive-fontsextra          texlive-latex-extra
%   texlive-genericextra        texlive-generic-extra
%   texlive-latexextra          texlive-lang-all
%
...
\usepackage[T1]{fontenc}                                    % hyphenation of words with Ã¤,Ã¶ and Ã¼
...
\include{kapitel/ZephyrOS}
\include{kapitel/nRF52DK}
\include{kapitel/DemoApp}
