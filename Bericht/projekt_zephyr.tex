...
\usepackage[T1]{fontenc}                                    % hyphenation of words with äöü
...
\include{kapitel/ZephyrEntwicklung}
\include{kapitel/FreeRTOS}
\include{kapitel/RIOT}
\include{kapitel/ContikiOS}
\include{kapitel/NuttXOS}
\include{kapitel/Vergleich}
