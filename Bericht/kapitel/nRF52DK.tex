...
Das nRF52 DK ist eine single-Board Entwicklungsplatform welche für die Verwendung von \ac{BLE}, ANT, und proprietären 2.4GHz Protokollen ausgelegt ist. Herzstück des Kits ist das nRF52832 \ac{SoC}.
...
Um die Funktion aller Tools und der SDK zu gewährleisten, sollten folgende Installationen ausschliesslich in der hier beschriebenen Reihenfolge ausgeführt werden. Da sich die Installation unter Ubuntu und Arch Linux unterscheiden, sind im nachfolgenden beide Varianten dokumentiert. 
