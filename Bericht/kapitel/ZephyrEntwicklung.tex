...
Nachfolgend ein Beispiel für Minimalprogramm mit Einbindung des Zephyrkernels. Das Programm enthält die Konfiguration der LED Pinnummern fürs nRF52 Board. Passt man diese jedoch an, sollte es auf jeder Plattform lauffähig sein.
